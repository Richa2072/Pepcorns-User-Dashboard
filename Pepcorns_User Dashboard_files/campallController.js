app.controller('campallController', ['$scope','$state','$http','apiService','authService','$compile','Upload','CONSTANT','$ngConfirm','$sce','helperService',function($scope,$state,$http,apiService,authService,$compile,Upload,CONSTANT,$ngConfirm,$sce,helperService){
    var self = $scope;
    ...
    self.getCampaignDetailsById = function(id){
        ...
        apiService.getCampaignDetailsById({"camp_id":id}).then(function (data) {
            ...
            if(self.selectedCampDetails.feature_video){
                $scope.currentVdo = self.selectedCampDetails.feature_video;
                //$scope.videoSource = $sce.trustAsResourceUrl(self.selectedCampDetails.feature_video);
            }
    ...
    // self.deleteCommentsById = function(id){
    //     self.showLoader=true;
    //     apiService.deleteCommentsById({
    //         comment_id:id
    //     }).then(function(data){
    //         self.getAllComments(true);
    //         self.newCommentadd = {
    ...
    //         }
    //         self.showLoader=false;
    //         createAlertSucc("comment has been removed");
    //     },function(data){
    //         self.showLoader=false;
    //         createAlertSucc(data)
    //     })
